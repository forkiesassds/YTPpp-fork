        ...
        /*public void effect_RainbowTrail(string video, int width, int height, double startOfClip, double endOfClip)
        {
            ...
            try
            {
                ...
                startInfo.Arguments = "-i " + temp
                        + " -vf "
                        + "scale=" + width.ToString("0.#########################", new CultureInfo("en-US")) + "x" + height.ToString("0.#########################", new CultureInfo("en-US")) + ",setsar=1:1,fps=fps=30" + toolBox.ACCEL
                        + " -y " + temp2;
                startInfo.UseShellExecute = false;
                startInfo.RedirectStandardOutput = true;
                process.StartInfo = startInfo;
